...
import personal.luissanchez.scheduler.db.TaskContract;
import personal.luissanchez.scheduler.db.TaskDbHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showAddDialog() {
        ...
        timeEditText.setHint("For how long? (Minutes)");
        layout.addView(timeEditText);

        //TODO: Check if EditText is not valid
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // TODO: Move myIntent to "Do" button onClick

                        Intent myIntent = new Intent(MainActivity.this, TimerActivity.class);
                        myIntent.putExtra("task", String.valueOf(taskEditText.getText()));
                        myIntent.putExtra("time", String.valueOf(timeEditText.getText()));
    ...
    private void updateUI() {
        ...
        Cursor cursor = db.query(TaskContract.TaskEntry.TABLE,
                new String[]{TaskContract.TaskEntry._ID, TaskContract.TaskEntry.COL_TASK_TITLE, TaskContract.TaskEntry.COL_TASK_TIME},
        ...
        if (mAdapter == null) {
            // TODO: Read task_time from database
